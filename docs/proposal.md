...
![Figure 5: Archetype Card — a pre-match summary showing archetype badges, historical outcome rates, and similar matches for Argentina vs. Saudi Arabia (2022).](/docs/figures/fig6_archetype_card.jpg)

![Figure 6: Dashboard mockup — archetype-aware matchup analysis dashboard.](/docs/figures/fig5_dashboard_mockup.jpg)
